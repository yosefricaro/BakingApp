...
public class ItemDetailActivityTest {
    ...
    @Test
    public void itemDetailActivityTest() {
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.rightButton), withText("Right"), isDisplayed()));
        ...
        ViewInteraction appCompatButton6 = onView(
                allOf(withId(R.id.leftButton), withText("Left"), isDisplayed()));
